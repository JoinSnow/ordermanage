...
<head>
    ...
    <title>新增订单</title>
    <meta name="description" content="新增订单">
    <meta name="keywords" content="新增订单">
        ...
        <section class="content"> <!--订单信息-->
            <div class="panel panel-default">
                <div class="panel-heading">
                    选择产品
                    <select class="form-group form-inline">
